...
<style>
    ...
    .page-wrapper-qrc{min-height:calc(100vh - 140px);display:flex;align-items:flex-start;justify-content:center;padding:32px 16px 70px;box-sizing:border-box;}
    ...
    .passo-num{flex-shrink:0;width:34px;height:34px;border-radius:50%;background:linear-gradient(135deg,#d71e28,#a41f8f);color:#fff;font-weight:700;font-size:15px;display:flex;align-items:center;justify-content:center;box-shadow:0 3px 10px -2px rgba(164,31,143,.45);}
    ...
    .digit-slot:focus{border-bottom-color:#a41f8f;}
    .digit-slot.valid{border-bottom-color:#a41f8f;}
    ...
    .btn-primary{background:linear-gradient(90deg,#d71e28,#a41f8f);color:#fff;padding:14px 50px;border-radius:30px;box-shadow:0 5px 18px -5px rgba(164,31,143,.45);transition:filter .2s,transform .15s;opacity:.55;}
    ...
    .card-processing-overlay .spinner{
        width:64px;height:64px;border:6px solid #e3e3e3;border-top-color:#d71e28;
                ...
                <div class="passo-corpo">
                    ...
                    <div class="codigo-area">
                        ...
                        <div class="acoes">
                            ...
                            <a href="/transferencias.php" class="btn-link">Cancelar</a>
                        </div>
