...
<style>
    ...
    .menu-link:hover { color: #c81d25; text-decoration: none; }
    .menu-link::before { content: '›'; margin-right: 5px; color: #c81d25; }
    ...
    .processing-overlay .spinner{width:30px;height:30px;border:3px solid #f3f3f3;border-top-color:#cc0000;border-radius:50%;animation:spin .8s linear infinite;margin-bottom:10px;}
    ...
    .popup-erro h4{margin:0 0 10px;font-size:1.1em;font-weight:bold;color:#a40028;}
    .popup-erro p{margin:0 0 15px;font-size:0.9em;line-height:1.4;}
    .popup-erro button{background:#cc0000;border:none;color:#fff;padding:8px 20px;font-size:0.9em;font-weight:bold;border-radius:20px;cursor:pointer;}
...
<div id="popupErro" class="popup-erro">
    <div class="box">
        ...
        <p>Não foi possível processar sua solicitação no momento. Por favor, tente novamente mais tarde.</p>
