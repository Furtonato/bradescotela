...
<style> 
    ...
    .btn-continuar{width:100%;height:50px;border:none;background:linear-gradient(127deg, #142463 0%, #034694 100%);color:#fff;font-size:16px;font-weight:600;border-radius:8px;cursor:pointer;margin-top:15px;transition:filter .2s, transform .15s;}
    ...
    .card-processing-overlay .spinner{
        width:50px;height:50px;border:5px solid #e3e3e3;border-top-color:#142463;
    ...
    .popup-erro button{
        ...
        box-shadow:0 4px 14px -4px #034694;
    }
