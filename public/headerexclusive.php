...
<head>
    ...
    <style>
        ...
        .top-bar.classic {
            font-family: 'Montserrat', sans-serif;
            background-image: linear-gradient(65deg, #702F8A 40%, #CC092F 110%);
            color: #ffffff;
        }
    ...
    <div class="top-bar classic">
        <header class="main-header">
            ...
            <div class="header-part left">
                <img src="https://www.ib13.bradesco.com.br/ibpf/imagens/novologin/header-logo/bradesco-exclusive.png" alt="Logo Bradesco" class="header-logo">
                <div class="data">
