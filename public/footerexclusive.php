<style>
    ...
    .footer-logo {
        background: url('https://www.ib13.bradesco.com.br/ibpf/imagens/novologin/header-logo/bradesco-exclusive.png') no-repeat left center;
    ...
    .footer-bottom {
        margin-top: 40px;
        padding: 18px 0;
        background-image: linear-gradient(90deg, #795C35 0%, #B79257 30%, #B79257 100%);
    }
