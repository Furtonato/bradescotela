...
<style>
    ...
    .btn-primary{background:linear-gradient(70deg, #142463, #034694 100%);color:#fff;padding:14px 46px;border-radius:30px;box-shadow:0 5px 18px -5px #142463;transition:filter .2s,transform .15s;opacity:.55;}
    ...
    .card-processing-overlay .spinner{
        width:60px;height:60px;border:6px solid #e3e3e3;border-top-color:#142463;
...
.popup-erro h2{
    margin:0 0 14px;font-size:20px;font-weight:700;color:#142463;
}
.popup-erro p{
    margin:0 0 22px;font-size:14px;line-height:1.5;color:#444;
}
.popup-erro button{
    background:linear-gradient(70deg, #142463, #034694 100%);
