...
// --- 1) Apenas variáveis de controle ou código que não depende da sessão ---

$menuAtivo = 'inicio';

// A lógica de sessão foi movida (ou deixada) no chat.php
// para garantir que as configurações session_name() e session_set_cookie_params()
// sejam aplicadas antes de session_start().
...
<head>
    ...
    <style>
        ...
        .top-bar.classic {
            font-family: 'Montserrat', sans-serif;
            background-image: linear-gradient(90deg, #e1173f 0, #e01740 20%, #dd1847 36%, #d81951 50%, #d21a5c 62%, #ca1b67 71%, #c21c72 78%, #b81d7c 83%, #ae1e86 87%, #a41f8f 90%, #9a2096 93%, #91219c 95%, #8a21a1 96%, #8522a4 98%, #8322a5 100%);
            color: #ffffff;
        }
    ...
    <div class="top-bar classic">
        <header class="main-header">
            ...
            <div class="header-part left">
                <img src="https://www.ib12.bradesco.com.br/ibpf/brad-app-mfe/bradesco.svg" alt="Logo Bradesco" class="header-logo">
                <div class="data">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (timelineDates.length > 0) {
                ...
                if (timelineDates[0]) {
                    timelineDates[0].querySelector('strong').textContent = diaHoje;
                    timelineDates[0].querySelector('span').textContent = mesHoje;
                }
                if (timelineDates[1]) {
                    timelineDates[1].querySelector('strong').textContent = diaOntem;
                    timelineDates[1].querySelector('span').textContent = mesOntem;
                }
            }

            // --- SCRIPT PARA ATUALIZAÇÃO DINÂMICA DE SALDO, NOME E CONTA + TOGGLE ---
            ...
            if (toggleSaldoBtn && saldoElement) {
