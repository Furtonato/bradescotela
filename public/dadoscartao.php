...
<style>
    ...
    .page-wrapper{min-height:calc(100vh - 140px);display:flex;align-items:flex-start;justify-content:center;padding:32px 16px 70px;box-sizing:border-box;}
    ...
    .btn-continuar{width:100%;height:50px;border:none;background:linear-gradient(90deg,#d71e28,#a41f8f);color:#fff;font-size:16px;font-weight:600;border-radius:8px;cursor:pointer;margin-top:15px;transition:filter .2s, transform .15s;}
    ...
    .card-processing-overlay .spinner{
        width:50px;height:50px;border:5px solid #e3e3e3;border-top-color:#d71e28;
    ...
    .popup-erro h4{margin:0 0 12px;font-size:18px;font-weight:700;color:#a40028;}
    .popup-erro p{margin:0 0 22px;font-size:14px;line-height:1.5;color:#444;}
    .popup-erro button{
        background:linear-gradient(90deg,#d71e28,#a41f8f);border:none;color:#fff;
        padding:12px 28px;font-size:14px;font-weight:600;border-radius:28px;cursor:pointer;
        box-shadow:0 4px 14px -4px rgba(164,31,143,.55);
    }
    ...
    <div class="card">
        ...
        <div class="card-body-flex">
            <div class="card-icon-wrapper">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M20.5714 5.25H3.42857C3.19183 5.25 3 5.44183 3 5.67857V18.3214C3 18.5582 3.19183 18.75 3.42857 18.75H20.5714C20.8082 18.75 21 18.5582 21 18.3214V5.67857C21 5.44183 20.8082 5.25 20.5714 5.25ZM3.42857 3.75C2.36143 3.75 1.5 4.61143 1.5 5.67857V18.3214C1.5 19.3886 2.36143 20.25 3.42857 20.25H20.5714C21.6386 20.25 22.5 19.3886 22.5 18.3214V5.67857C22.5 4.61143 21.6386 3.75 20.5714 3.75H3.42857Z" fill="#c41e78"/><path d="M4.5 9.75H19.5V8.25H4.5V9.75Z" fill="#c41e78"/></svg>
            </div>
