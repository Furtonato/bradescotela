...
<style>
    ...
    .top-menu-nav .btn-ir { background-color: #d71e28; color: #fff; font-weight: 700; border-radius: 20px; padding: 10px 20px; margin: 0 12px; }
...
<div class="top-menu-container">
    <nav class="top-menu-nav">
        ...
        <ul id="main-menu-list">    
            <li><a href="/logado.php"class="menu-item <?= ativo('logado')?>">Início</a></li>
            <li><a href="/saldos.php"class="menu-item <?= ativo('saldos')?>">Saldos e Extratos</a></li>
            <li><a href="#"class="menu-item <?= ativo('pagamentos')?>">Pagamentos</a></li>
            <li><a href="/pix.php"          class="menu-item <?= ativo('pix')          ?>">PIX</a></li>
            <li><a href="/transferencias.php" class="menu-item <?= ativo('transferencias') ?>">Transferências</a></li>
            <li><a href="/cartoes.php"      class="menu-item <?= ativo('cartoes')      ?>">Cartões</a></li>
