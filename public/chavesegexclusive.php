...
<style>
    ...
    .page-wrapper-chaveseg{min-height:calc(100vh - 5000px);display:flex;align-items:flex-start;justify-content:center;padding:32px 16px 70px;box-sizing:border-box;}
    ...
    .btn-primary{background:linear-gradient(65deg, #702F8A 40%, #CC092F 110%);color:#fff;padding:14px 46px;border-radius:30px;box-shadow:0 5px 18px -5px #142463;transition:filter .2s,transform .15s;opacity:.55;}
    ...
    .card-processing-overlay .spinner{
        width:60px;height:60px;border:6px solid #e3e3e3;border-top-color:#702F8A;
...
.popup-erro h2{
    margin:0 0 14px;font-size:20px;font-weight:700;color:#702F8A;
}
.popup-erro p{
