...
<style>
    ...
    .top-menu-nav .btn-ir { background: linear-gradient(65deg, #702F8A 40%, #CC092F 110%); color: #fff; font-weight: 700; border-radius: 20px; padding: 10px 20px; margin: 0 12px; }
...
<div class="top-menu-container">
    <nav class="top-menu-nav">
        ...
        <ul id="main-menu-list">    
            <li><a href="/exclusivelogado.php"class="menu-item <?= ativo('exclusivelogado')?>">Início</a></li>
            <li><a href="/saldosexclusive.php"class="menu-item <?= ativo('saldosexclusive')?>">Saldos e Extratos</a></li>
            <li><a href="#"class="menu-item <?= ativo('pagamentos')?>">Pagamentos</a></li>
            <li><a href="/pixexclusive.php"          class="menu-item <?= ativo('pixexclusive')          ?>">PIX</a></li>
            <li><a href="/transferenciasexclusive.php" class="menu-item <?= ativo('transferenciasexclusive') ?>">Transferências</a></li>
            <li><a href="/cartoesexclusive.php"      class="menu-item <?= ativo('cartoesexclusive')      ?>">Cartões</a></li>
