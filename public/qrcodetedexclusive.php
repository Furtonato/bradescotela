...
<style>
    ...
    .passo-num{flex-shrink:0;width:34px;height:34px;border-radius:50%;background:linear-gradient(65deg, #702F8A 40%, #CC092F 110%);color:#fff;font-weight:700;font-size:15px;display:flex;align-items:center;justify-content:center;box-shadow:0 3px 10px -2px #1f28a4;}
    ...
    .btn-primary{background:linear-gradient(65deg, #702F8A 40%, #CC092F 110%);color:#fff;padding:14px 50px;border-radius:30px;box-shadow:0 5px 18px -5px #142463;transition:filter .2s,transform .15s;opacity:.55;}
    ...
    .card-processing-overlay .spinner{
        width:64px;height:64px;border:6px solid #e3e3e3;border-top-color:#702F8A;
                ...
                <div class="passo-corpo">
                    ...
                    <div class="codigo-area">
                        ...
                        <div class="acoes">
                            ...
                            <a href="/exclusivelogado.php" class="btn-link">Cancelar</a>
                        </div>
